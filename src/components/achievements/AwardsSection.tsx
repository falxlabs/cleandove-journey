...
const awards = [
  ...
  },
  {
    ...
    levels: [
      ...
      { value: 24, requirement: "Complete 24 weekend days" },
      { value: 36, requirement: "Complete 36 weekend days" },
      { value: 48, requirement: "Complete 48 weekend days" },
      { value: 52, requirement: "Complete 52 weekend days" },
    ],
    currentLevel: 6,
    progress: "45 of 48",
    icon: "⚔️",
